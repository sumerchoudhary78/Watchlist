...
urlpatterns = [
    ...
    # path('reviews/<str:username>', UserReview.as_view(), name='user-review-detail'), # If information is given
    path('reviews/', UserReview.as_view(), name='user-review-detail') # for query search
]